...
class BasketsControllerTest < ActionController::TestCase
  ...
  test "should create basket" do
    assert_difference('Basket.count') do
      post :create, basket: { donation: @basket.donation, number: @basket.number, product_id: @basket.product_id, user_id: @basket.user_id }
    end
  ...
  test "should update basket" do
    patch :update, id: @basket, basket: { donation: @basket.donation, number: @basket.number, product_id: @basket.product_id, user_id: @basket.user_id }
    assert_redirected_to basket_path(assigns(:basket))
  end
