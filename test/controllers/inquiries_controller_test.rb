...
class InquiriesControllerTest < ActionController::TestCase
  ...
  test "should create inquiry" do
    assert_difference('Inquiry.count') do
      post :create, inquiry: { answer: @inquiry.answer, classification: @inquiry.classification, content: @inquiry.content, email: @inquiry.email, title: @inquiry.title, user_id: @inquiry.user_id }
    end
  ...
  test "should update inquiry" do
    patch :update, id: @inquiry, inquiry: { answer: @inquiry.answer, classification: @inquiry.classification, content: @inquiry.content, email: @inquiry.email, title: @inquiry.title, user_id: @inquiry.user_id }
    assert_redirected_to inquiry_path(assigns(:inquiry))
  end
